...
export const createList = axios => (boardId, list) => request(axios.post("/board/list", {boardId, list}));
export const changeList = axios => (boardId, list) => request(axios.put("/board/list", {boardId, list}));
